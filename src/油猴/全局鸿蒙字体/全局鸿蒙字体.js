...
;(function () {
  ...
  const domainCssMap = new Map([
    [
      'baidu.com',
      '*{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif}',
    ],
    [
      'bilibili.com',
      '.lite-room,.header-channel,.channel-menu-mini,.bb-comment,.list-item .user .text-con,.video-page-card-small .card-box .info .title,.video-info-v1 .video-title,.carousel-tool,.bili-comment.browser-pc *,.bili-dyn-content,.bili-rich-text,.bili-dyn-item,.bili-video-card__info--bottom,.bili-header,.bili-video-card__info--tit,.bili-video-card__info--tit a,.browser-pc *,.video-page-card-small .card-box .info .title,.up-info-v1 .up-info_right .name,.first-line-title,.pl__head,.pl__title{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'bing.com',
      'h1,h2,h3,.b_searchboxForm{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'feishu.cn',
      '#zh-CN button,#zh-CN input,#zh-CN select,#zh-CN textarea,.markdown-body{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}.code-block-content,.markdown-body code,.markdown-body pre{font-family:"JetBrainsMono Nerd Font Mono","Cascadia Mono",Menlo,Monaco,Consolas,"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'google.com',
      '*{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif}h3,textarea,#result-stats{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'mail.qq.com',
      'td,input,button,select,body,.qm_con_body_content,.tcolor,.sub_title{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'miit.gov.cn',
      '*{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'mp.weixin.qq.com',
      '.wx_wap_page{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'nxboom.com',
      'body,h1,h2,h3,h4,h5,h6,.h1,.h2,.h3,.h4,.h5,.h6{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'taobao.com',
      'body,button,input,select,textarea{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
    [
      'vercel.com',
      '[class^=__variable]{--font-sans: HarmonyOS Sans SC !important;--font-mono: JetBrainsMono Nerd Font Mono !important}',
    ],
    [
      'wikiwand.com',
      '#article-root{--font-sans: HarmonyOS Sans SC !important;--font-serif: Noto Serif SC !important}',
    ],
    [
      'yuque.com',
      '.doc-title,.ne-engine,.ne-viewer-body,.ne-toc-view,.DocReader-module_title_fXOQi>h1,.catalogTreeItem-module_title_snpKw{font-family:"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}.cm-line,ne-code-content{font-family:"JetBrainsMono Nerd Font Mono","Cascadia Mono",Menlo,Monaco,Consolas,"HarmonyOS Sans SC",Cus_Emoji,"Noto Sans SC","Noto Sans JP","Noto Sans KR","Noto Naskh Arabic","Segoe UI",Roboto,Helvetica,Arial,sans-serif !important}',
    ],
  ])
