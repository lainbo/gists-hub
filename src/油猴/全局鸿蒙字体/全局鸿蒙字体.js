...
kbd,
samp {
  font-family: 'Source Han Mono SC', 'Noto Sans Mono CJK SC', 'JetBrainsMono Nerd Font Mono',
...
html:lang(zh-cmn-Hant) samp {
  font-family: 'Source Han Mono TC', 'Noto Sans Mono CJK TC', 'JetBrainsMono Nerd Font Mono',
    'Noto Mono', 'SF Mono', 'Roboto Mono', ui-monospace, monospace,
    'Apple Color Emoji', 'Twemoji Mozilla', 'Segoe UI Symbol', 'Noto Color Emoji',
    emoji;
}
...
html:lang(zh-yue-Hant) samp {
  font-family: 'Source Han Mono HC', 'Noto Sans Mono CJK HC',
    'Source Han Mono TC', 'Noto Sans Mono CJK TC', 'JetBrainsMono Nerd Font Mono', 'Noto Mono',
...
html:lang(ms) kbd,
html:lang(ms) samp {
  font-family: 'JetBrainsMono Nerd Font Mono', 'Noto Mono', 'SF Mono', 'Roboto Mono',
...
`
  ...
  if (location.hostname === 'feishu.cn' || location.hostname.endsWith('.feishu.cn')) {
    ...
    .markdown-body code,
    .markdown-body pre{
       font-family: 'JetBrainsMono Nerd Font Mono', 'Noto Sans Mono CJK SC',
